//Pour fichier types de données

//1 String
//let presentation = "Je m'appelle Mickael";
let presentation = 'Je m\'appelle Mickael.';
...
//1- récupérer dans le doc un élément dont l'id est x
//2- remplacer le contenu d'un élément identifié par son id 
//3- Puis on concatène une string et le résultatde la fonction typeof()
...
let monFilm1 = 'Mon film préféré est "20 000 lieux sous les mers" avec Kirk Doublas';
